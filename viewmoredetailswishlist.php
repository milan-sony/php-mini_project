...
<body>
    ...
    <ul>
        <li class="f1"><h2>Property name<h2></li>
    ...
    <table>
      <tr>
        <td><?php echo "<center><button class='button'><a class='anchor' onclick='return checkremove()' href=wishlistremove.php?id=".$row['pid'].">Remove from wishlist</a></button></center>"?></td>
        <td><?php echo "<center><button class='button2'><a class='anchor2' href=contactseller.php?id=".$row['pid'].">View contact</a></button></center>"?></td>
        <td><?php echo "<center><button class='button3'><a class='anchor2' href=wishlistview.php?id=".$row['pid'].">Cancel</a></button></center>"?></td>
      </tr>
    </table>
    </center>
