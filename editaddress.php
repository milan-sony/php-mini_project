...
<body>
    <center>
        <div class="box">
            <h3>Edit your address</h3><br>
            <form>
                <input type="text" name="new_address" placeholder="Enter your new address" required autocomplete="off"><br>
                <table>
                    <tr>
...
<?php
    ...
    {
        $newaddress = $_REQUEST['new_address'];
        $id = $_SESSION['id'];
        $sql = "UPDATE accounts SET address='".$newaddress."' WHERE id='".$id."'";
