...
<body>
    <center>
        <div class="box">
            <h3>Edit your username</h3><br>
            <form>
                <input type="text" name="new_name" placeholder="Enter your new username" required autocomplete="off"> <br>
                <table>
                    <tr>
...
<?php
    ...
    if(isset($_REQUEST["submit"]))
    {
        ...
        $id = $_SESSION['id'];
        $sql = "UPDATE accounts SET username='".$newname."' WHERE id='".$id."'";
