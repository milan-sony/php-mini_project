...
<body>
    <center>
        <div class="box">
            <h3>Edit your E-mail ID</h3><br>
            <form>
                <input type="email" name="new_email" placeholder="Enter your new Email id" required autocomplete="off">
                <table>
                    <tr>
...
<?php
    ...
    if(isset($_REQUEST["submit"]))
    {
        ...
        $id = $_SESSION['id'];
        $sql = "UPDATE accounts SET email='".$newemail."' WHERE id='".$id."'";
