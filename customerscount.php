...
<?php
  ...
  if($res){
    ...
    <center>
      <table border="0">
        <tr>
          <td><h1>Total number of customers</h1></td>
        </tr>
        <tr>
          <td><h3><?php echo mysqli_num_rows($res);?></h3> <h6># including admin</h6></td>
        </tr>
        <tr>
          <td><h4><a href="viewallcustomers.php">View all customer details</a></h4></td>
        </tr>
      </table>
<?php
}
