...
<body>
    ...
    <table>
        <tr>
            ...
            <td><button class="button2"><?php echo "<a class='anchor2' href=contactdetailsadmin.php?id=$row[0]>View contact</a>"?></button></td>
            <td><button class="button3"><?php echo "<a class='anchor2' href=viewallproperties.php?id=$row[0]>Cancel</a>"?></button></td>   
        </tr>
    </table>
    </center>
...
<?php
    ...
    echo "You have not added any prpoerties";
}
?>